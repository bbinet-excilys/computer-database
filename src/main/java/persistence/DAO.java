...
/**
 * Base class for DAOs Contains default queries ready to accept parameters.
 *
 * @author bbinet
 * @param <T>
...
public abstract class DAO<T extends Entity> {
   ...
   * <li>The list of columns in which the values will be inserted, separated by
   * commas</li>
   * <li>Must be a list of question marks, one for each column in the columns
   * param</li>
   * </ul>
   */
   ...
   * <li>The list of columns to update, such as : "column=?", seperated by
   * commas</li>
